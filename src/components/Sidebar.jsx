      ...
      <nav className={`sidebar ${sideme ? "active" : ""}`}>
        ...
        <ul className="sidebar-menu" >
          <li>
            ...
            <NavLink className="sidebar-item" onClick={handleStaffRecord}>
              <span className="sidebar-icon">
                <svg
                  width="20"
                  height="20"
              ...
              <span className="sidebar-label">Staff Records</span>
            </NavLink>

            <NavLink className="sidebar-item" onClick={handleFileTracking}>
              <span className="sidebar-icon">
                <svg
                  width="20"
                  height="20"
              ...
              <span className="sidebar-label">File Tracking</span>
            </NavLink>

            <NavLink className="sidebar-item" onClick={handleReports}>
              <span className="sidebar-icon">
                <svg
                  width="20"
                  height="20"
            ...
            <NavLink className="sidebar-item" onClick={handleNewFile}>
              <span className="sidebar-icon">
                <svg
                  width="20"
                  height="20"
              ...
              <span className="sidebar-label">Add New File</span>
            </NavLink>
          </li>
        </ul>
      </nav>
